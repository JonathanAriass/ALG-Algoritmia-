...
//			counter++;
	...
	/*
	 * private void printSol() { System.out.print("["); for (int i : sol) {
	 * System.out.print(i + ", "); } System.out.println("]"); }
	 */

	public void main() {
		
		branchAndBound(new NodeAvg(dataset, new ArrayList<Integer>(), width, height));
		half1_img = bestNode.half1;
		half2_img = bestNode.half2;
		avg_img = new Imagen(width, height);
		avg_img.addSignal(half1_img);
		avg_img.addSignal(half2_img);
		System.out.println("Zncc: " + this.zncc());
	}
